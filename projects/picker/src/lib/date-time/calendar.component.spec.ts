...
import { MockNgZone, dispatchFakeEvent, dispatchMouseEvent, dispatchKeyboardEvent } from '../../test-helpers';
...
describe('OwlCalendarComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [StandardCalendar, CalendarWithMinMax, CalendarWithDateFilter],
