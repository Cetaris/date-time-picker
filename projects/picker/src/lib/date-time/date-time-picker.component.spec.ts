...
import { dispatchKeyboardEvent, dispatchMouseEvent, createKeyboardEvent, dispatchEvent, dispatchFakeEvent } from '../../test-helpers';
...
describe('OwlDateTimeComponent', () => {
  ...
  describe('with missing DateTimeAdapter and OWL_DATE_TIME_FORMATS', () => {
    it('should throw when created', () => {
      expect(() => createComponent(StandardDateTimePicker)).toThrowError(/OwlDateTimePicker: No provider found for .*/);
    });
  });
});
...
@Component({
  template: `
    ...
    <owl-date-time [opened]="opened" [disabled]="disabled" [pickerType]="pickerType" [pickerMode]="pickerMode" #dt></owl-date-time>
  `,
})
...
@Component({
  template: `
    ...
    <owl-date-time [startAt]="startAt" [pickerType]="pickerType" #dt></owl-date-time>
  `,
})
...
@Component({
  template: `
    <input [owlDateTime]="dt" [value]="date" />
    <owl-date-time #dt [startView]="startView" (monthSelected)="onMonthSelection()" (yearSelected)="onYearSelection()"></owl-date-time>
  `,
})
...
@Component({
  template: `
    <input [formControl]="formControl" [owlDateTime]="dt" [owlDateTimeTrigger]="dt" />
    <owl-date-time #dt></owl-date-time>
  `,
})
...
@Component({
  template: `
    <input [(ngModel)]="date" [min]="min" [max]="max" [owlDateTime]="dt" [owlDateTimeTrigger]="dt" />
...
@Component({
  template: `
    <input [(ngModel)]="date" [owlDateTimeFilter]="filter" [owlDateTime]="dt" [owlDateTimeTrigger]="dt" />
    <owl-date-time [showSecondsTimer]="true" #dt></owl-date-time>
  `,
})
